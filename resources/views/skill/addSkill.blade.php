...
<script>
    document.title = 'Musicians Manager - Add Proficiency';
</script>

<div><h2>Add a new Proficiency</h2></div>
<div class="row">
...
<div class="col-md-12">
    ...
    <div class="container">
          <div class="col-md-5 pull-left" style="background-color:LightCyan; border:4px solid blue; border-radius:25px;">
            <h4 style="margin-top: -10px; background:white; width:160px">&nbsp;<b>Proficiency Information</b></h4>
            <div class="row">
        ...
        <div class='col-sm-2  pull-left'><br/>
            <table border='0'>
                <tr>
                    ...
                    <td>&nbsp;</td>
                    <td>
                        {!! Form::model(null, ['method' => 'get', 'route' => 'skill.index']) !!}
