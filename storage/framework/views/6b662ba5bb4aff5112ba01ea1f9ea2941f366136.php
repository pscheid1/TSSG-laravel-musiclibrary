...
<body>
    <?php if(Request::path() === '/XXX ' || Request::path() === 'auth/loginXXX'): ?>
    <!--<div id="header">
        <div id="logo">
    ...
    <?php endif; ?>
    <?php /*<nav class="navbar navbar-default navbar-inverse  navbar-fixed-top">*/ ?>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo e(route('nya')); ?>">List Events</a></li>
                            <li><a href="<?php echo e(route('nya')); ?>">Events Calendar</a></li>
                            <li><a href="<?php echo e(route('nya')); ?>">Add Event</a></li>
                            <li><a href="<?php echo e(route('nya')); ?>">Request Musician</a></li>
                            <li><a href="<?php echo e(route('nya')); ?>">Musician Response</a></li>
                            <li> <a href="<?php echo e(route('nya')); ?>">List Venues</a></li>
                            <li><a href="<?php echo e(route('nya')); ?>">Add Venue</a></li>
                        </ul>
                    </li>
                    </li>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="<?php echo e(route('group.index')); ?>">List Groups</a></li>                                             
                            <li><a href="<?php echo e(route('group.create')); ?>">Add Group</a></li>
                        </ul>
                    </li> 
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown">Members<span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo e(route('user.index')); ?>">List Members</a></li>
                            <li><a href="<?php echo e(route('user.create')); ?>">Add Member</a></li>
                        </ul>
                    </li> 
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="<?php echo e(route('role.create')); ?>">Add Role</a></li>
                        </ul>
                    </li>
                    <?php endif; ?>
                </ul>
...
{
//debugger;
    document.location.href = "<?php echo route('nya'); ?>";
}
