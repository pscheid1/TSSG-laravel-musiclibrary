...
<table style="width:70%" border=".5" align="center" >
    ...
    <tr>
        ...
        <td><?php echo e($role->displayname); ?>

        <td style="width: 49px;">
            <span class="btn-group">
                <button type="button" class="btn btn-default btn-xs" onClick="doSubmit('get', '<?php echo e($role->id); ?>')">
                    <span class="glyphicon glyphicon-edit" aria-hidden="true"> </span>
                </button>
                <button type="button" class="btn btn-default btn-xs" onClick="doSubmit('delete', '<?php echo e($role->id); ?>')">
