...
<div><h2>Add Role to User: <?php echo e($user->username); ?></h2></div>
<div class="row">
...
<div class=""col-md-12>
    <?php echo Form::model($user, ['method' => 'post', 'route' => ['user.addrole', $user]]); ?>
    ...
    <div class="container">
        <div class="col-md-5 pull-left" style="background-color:LightCyan; adding:4px;border:4px solid blue; border-radius:25px;">
            ...
            <div class="row">
                ...
                <div class="col-md-1 pull-left">
                    <?php echo Form::checkbox('loginpermitted', 1); ?>
        ...
        <div class="col-md-5 pull-right" style="background-color:LightCyan; adding:4px;border:4px solid blue; border-radius:25px;">
            ...
            <div class="row">
                ...
                <div class="col-md-1 pull-left">
                    <?php echo Form::select('currentRole', $availableRoles, null, ['placeholder' => '--- select one ---']); ?>                    
                </div>
            </div>
            <?php /*
            ...
            <table border='0'>
                <tr>
                    <td>
                     ...
                     <td>&nbsp;</td>
                    <td>                   
                        <?php echo Form::model($user, ['method' => 'get', 'route' => ['user.show', $user]]); ?>
