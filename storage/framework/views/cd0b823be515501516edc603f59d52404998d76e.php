    ...
    <div class="container">
        <div class="col-md-5 pull-left" style="background-color:LightCyan; adding:4px;border:4px solid blue; border-radius:25px;">
            ...
            <div class="row">
                ...
                <div class="col-md-1 pull-left">				
                    <?php echo Form::select('STYLEID', $stylesAdd, null, ['placeholder' => '- - - select one - - -']); ?>
            ...
            <div class="row">
                ...
                <div class="col-md-1 pull-left">
                    <?php echo Form::select('TEMPOID', $temposAdd, null, ['placeholder' => '- - - select one - - -']); ?>
            ...
            <div class="row">
                ...
                <div class="col-md-1 pull-left">
                    <?php echo Form::text('STDPLAYTIME', null , ['placeholder' => 'hh:mm:ss']); ?>
            ...
            <div class="row">
                ...
                <div class="col-md-1 pull-left">
                    <?php echo Form::text('EXTPLAYTIME', null , ['placeholder' => 'hh:mm:ss']); ?>
