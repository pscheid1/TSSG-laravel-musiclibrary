...
<div><h2>Edit Style: <?php echo e($style->DESCRIPTION); ?></h2></div>
<div class="row">
...
<div class="col-md-12">
    <?php echo Form::model($style, ['method' => 'PATCH', 'route' => ['style.update', $style]]); ?>
    ...
    <div class="container">
        <div class="col-md-5 pull-left" style="background-color:LightCyan; adding:4px;border:4px solid blue; border-radius:25px;">
            ...
            <div class="row">
                ...
                <div class="col-md-1 pull-left">
                    <?php echo Form::text('UPDATEUSERID', $updateusername , ['disabled' => 'true']); ?>
        ...
        <div class='col-sm-2  pull-left'><br/>
            <table border='0'>
                <tr>
                    ...
                    <td>&nbsp;</td>
                    <td>
                        <?php echo Form::model($style, ['method' => 'get', 'route' => 'style.index']); ?>
